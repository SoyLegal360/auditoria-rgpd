...
- AVISO LEGAL (LSSI-CE art. 10): identificación del titular (art. 10.1.a) — si es persona jurídica, su denominación social; si es persona física/autónomo, su NOMBRE Y APELLIDOS (un nombre comercial o marca por sí solo, p. ej. "Centro X" o "Clínica Y", NO cumple: debe constar la persona física identificada); NIF/DNI del titular (art. 10.1.e); domicilio; email de contacto; datos registrales si procede; condiciones de uso y propiedad intelectual.
